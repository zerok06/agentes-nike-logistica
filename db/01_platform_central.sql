...
VALUES
-- == RUNNING (cat 1) ==
('pd000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',1,
...
('pd000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',1,
...
('pd000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',1,
...
('pd000004-0000-0000-0000-000000000004','11111111-1111-1111-1111-111111111111',1,
...
-- == LIFESTYLE (cat 2) ==
('pd000005-0000-0000-0000-000000000005','11111111-1111-1111-1111-111111111111',2,
...
('pd000006-0000-0000-0000-000000000006','11111111-1111-1111-1111-111111111111',2,
...
('pd000007-0000-0000-0000-000000000007','11111111-1111-1111-1111-111111111111',2,
...
('pd000008-0000-0000-0000-000000000008','11111111-1111-1111-1111-111111111111',2,
...
('pd000009-0000-0000-0000-000000000009','11111111-1111-1111-1111-111111111111',2,
...
('pd000010-0000-0000-0000-000000000010','11111111-1111-1111-1111-111111111111',2,
...
('pd000011-0000-0000-0000-000000000011','11111111-1111-1111-1111-111111111111',2,
...
('pd000012-0000-0000-0000-000000000012','11111111-1111-1111-1111-111111111111',2,
...
('pd000013-0000-0000-0000-000000000013','11111111-1111-1111-1111-111111111111',2,
...
('pd000014-0000-0000-0000-000000000014','11111111-1111-1111-1111-111111111111',2,
...
-- == TRAINING (cat 3) ==
('pd000015-0000-0000-0000-000000000015','11111111-1111-1111-1111-111111111111',3,
...
('pd000016-0000-0000-0000-000000000016','11111111-1111-1111-1111-111111111111',3,
...
('pd000017-0000-0000-0000-000000000017','11111111-1111-1111-1111-111111111111',3,
...
('pd000018-0000-0000-0000-000000000018','11111111-1111-1111-1111-111111111111',3,
...
-- == BASKETBALL (cat 4) ==
('pd000019-0000-0000-0000-000000000019','11111111-1111-1111-1111-111111111111',4,
...
('pd000020-0000-0000-0000-000000000020','11111111-1111-1111-1111-111111111111',4,
...
-- == FÚTBOL (cat 5) ==
('pd000021-0000-0000-0000-000000000021','11111111-1111-1111-1111-111111111111',5,
...
('pd000022-0000-0000-0000-000000000022','11111111-1111-1111-1111-111111111111',5,
...
-- == ROPA (cat 6) ==
('pd000023-0000-0000-0000-000000000023','11111111-1111-1111-1111-111111111111',6,
...
('pd000024-0000-0000-0000-000000000024','11111111-1111-1111-1111-111111111111',6,
...
('pd000001-0000-0000-0000-000000000001','AT8242-009',2.7,14, 0,159.95,0,
...
('pd000002-0000-0000-0000-000000000002','AJ6910-009',4.4,48, 0,169.95,0,
...
('pd000003-0000-0000-0000-000000000003','CK2595-500',5.0, 2, 0,149.95,0,
...
('pd000008-0000-0000-0000-000000000008','CJ1646-600', 0.0, 0, 0, 74.95,0,
 'Let your shoe game shimmer with premium leather upper and iridescent Swoosh.','nike_catalog'),
('pd000009-0000-0000-0000-000000000009','CZ6156-101', 0.0, 0, 0, 99.95,0,
...
('pd000010-0000-0000-0000-000000000010','CI3482-200', 0.0, 0, 0, 99.95,0,
...
('pd000011-0000-0000-0000-000000000011','CD0479-200', 0.0, 0, 0, 99.95,0,
...
VALUES
('wh000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',
 'Almacén Lima Centro','Lima','Av. Industrial 1250, Cercado de Lima',
 -12.046373,-77.042754, 8000),
('wh000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',
 'Almacén Arequipa','Arequipa','Parque Industrial Mz. G Lt. 4, Arequipa',
 -16.409047,-71.537451, 5000),
('wh000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
...
-- Lima Centro
('11111111-1111-1111-1111-111111111111','pd000001-0000-0000-0000-000000000001','wh000001-0000-0000-0000-000000000001',  8, 25,300), -- CRÍTICO
('11111111-1111-1111-1111-111111111111','pd000002-0000-0000-0000-000000000002','wh000001-0000-0000-0000-000000000001', 45, 20,250),
('11111111-1111-1111-1111-111111111111','pd000005-0000-0000-0000-000000000005','wh000001-0000-0000-0000-000000000001',120, 30,400),
('11111111-1111-1111-1111-111111111111','pd000006-0000-0000-0000-000000000006','wh000001-0000-0000-0000-000000000001',  7, 20,300), -- CRÍTICO
('11111111-1111-1111-1111-111111111111','pd000007-0000-0000-0000-000000000007','wh000001-0000-0000-0000-000000000001', 55, 15,200),
('11111111-1111-1111-1111-111111111111','pd000009-0000-0000-0000-000000000009','wh000001-0000-0000-0000-000000000001',  5, 20,250), -- CRÍTICO
('11111111-1111-1111-1111-111111111111','pd000015-0000-0000-0000-000000000015','wh000001-0000-0000-0000-000000000001', 30, 15,200),
('11111111-1111-1111-1111-111111111111','pd000017-0000-0000-0000-000000000017','wh000001-0000-0000-0000-000000000001',  7, 15,200), -- CRÍTICO
('11111111-1111-1111-1111-111111111111','pd000020-0000-0000-0000-000000000020','wh000001-0000-0000-0000-000000000001', 60, 10,150),
('11111111-1111-1111-1111-111111111111','pd000023-0000-0000-0000-000000000023','wh000001-0000-0000-0000-000000000001',200, 40,600),
-- Arequipa
('11111111-1111-1111-1111-111111111111','pd000001-0000-0000-0000-000000000001','wh000002-0000-0000-0000-000000000002',150, 25,300),
('11111111-1111-1111-1111-111111111111','pd000003-0000-0000-0000-000000000003','wh000002-0000-0000-0000-000000000002', 30, 15,200),
('11111111-1111-1111-1111-111111111111','pd000006-0000-0000-0000-000000000006','wh000002-0000-0000-0000-000000000002', 80, 20,300),
('11111111-1111-1111-1111-111111111111','pd000009-0000-0000-0000-000000000009','wh000002-0000-0000-0000-000000000002', 65, 20,250),
('11111111-1111-1111-1111-111111111111','pd000021-0000-0000-0000-000000000021','wh000002-0000-0000-0000-000000000002', 25, 10,150),
-- Moquegua
('11111111-1111-1111-1111-111111111111','pd000005-0000-0000-0000-000000000005','wh000003-0000-0000-0000-000000000003', 40, 15,150),
('11111111-1111-1111-1111-111111111111','pd000017-0000-0000-0000-000000000017','wh000003-0000-0000-0000-000000000003', 50, 15,200),
('11111111-1111-1111-1111-111111111111','pd000023-0000-0000-0000-000000000023','wh000003-0000-0000-0000-000000000003', 90, 30,400);
...
VALUES
('11111111-1111-1111-1111-111111111111','pd000001-0000-0000-0000-000000000001','wh000001-0000-0000-0000-000000000001',
 'salida', 42,'Pedido SO-2025-001 cliente Sport Center Lima','44444444-4444-4444-4444-444444444444', NOW()-INTERVAL '5 days'),
('11111111-1111-1111-1111-111111111111','pd000005-0000-0000-0000-000000000005','wh000001-0000-0000-0000-000000000001',
 'entrada',200,'Recepción OC-2025-001 de Nike Global Supply','44444444-4444-4444-4444-444444444444', NOW()-INTERVAL '10 days'),
('11111111-1111-1111-1111-111111111111','pd000006-0000-0000-0000-000000000006','wh000001-0000-0000-0000-000000000001',
 'salida', 30,'Distribución tienda Sport Zone Miraflores','44444444-4444-4444-4444-444444444444', NOW()-INTERVAL '3 days'),
('11111111-1111-1111-1111-111111111111','pd000009-0000-0000-0000-000000000009','wh000001-0000-0000-0000-000000000001',
 'salida', 25,'Evento Nike Run Lima 2025','33333333-3333-3333-3333-333333333333', NOW()-INTERVAL '7 days'),
('11111111-1111-1111-1111-111111111111','pd000001-0000-0000-0000-000000000001','wh000002-0000-0000-0000-000000000002',
 'entrada',200,'Reabastecimiento Q3 Nike Global Supply','44444444-4444-4444-4444-444444444444', NOW()-INTERVAL '20 days'),
('11111111-1111-1111-1111-111111111111','pd000023-0000-0000-0000-000000000023','wh000001-0000-0000-0000-000000000001',
...
VALUES
('tr000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',
 'pd000001-0000-0000-0000-000000000001',
 'wh000002-0000-0000-0000-000000000002','wh000001-0000-0000-0000-000000000001',
...
('tr000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',
 'pd000009-0000-0000-0000-000000000009',
 'wh000002-0000-0000-0000-000000000002','wh000001-0000-0000-0000-000000000001',
 30,'pending','44444444-4444-4444-4444-444444444444',NULL,
 'Reposición Air Max Verona Lima Centro', NOW()-INTERVAL '2 hours', NULL),
('tr000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
 'pd000006-0000-0000-0000-000000000006',
 'wh000002-0000-0000-0000-000000000002','wh000003-0000-0000-0000-000000000003',
...
VALUES
('sp000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',
 'Nike Global Supply','supply@nike.com','+1 503 671 6453','USA','Beaverton','manufacturer'),
('sp000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',
 'Distribuidora Deportiva Perú','ventas@deportivaperu.pe','+51 1 234 5678','Peru','Lima','distributor'),
('sp000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
...
VALUES
('po000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',
...
('po000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',
 'sp000002-0000-0000-0000-000000000002',
 CURRENT_DATE-5,  CURRENT_DATE+10,'pending',  12450.00,
 'Reposición urgente stock crítico Lima Centro'),
('po000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
 'sp000003-0000-0000-0000-000000000003',
...
('po000001-0000-0000-0000-000000000001','pd000001-0000-0000-0000-000000000001',100,119.95),
('po000001-0000-0000-0000-000000000001','pd000005-0000-0000-0000-000000000005',200, 59.95),
('po000001-0000-0000-0000-000000000001','pd000006-0000-0000-0000-000000000006',100, 79.95),
('po000002-0000-0000-0000-000000000002','pd000009-0000-0000-0000-000000000009', 50, 79.95),
('po000002-0000-0000-0000-000000000002','pd000017-0000-0000-0000-000000000017', 80, 59.95),
('po000003-0000-0000-0000-000000000003','pd000002-0000-0000-0000-000000000002',200,129.95),
('po000003-0000-0000-0000-000000000003','pd000007-0000-0000-0000-000000000007',150,129.95);
...
VALUES
('so000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',
 'cu000001-0000-0000-0000-000000000001',CURRENT_DATE-3,'shipped',  2249.60,'direct'),
('so000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',
 'cu000002-0000-0000-0000-000000000002',CURRENT_DATE-1,'confirmed',1099.75,'direct'),
('so000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
...
('so000001-0000-0000-0000-000000000001','pd000005-0000-0000-0000-000000000005',10, 74.95,0.05),
('so000001-0000-0000-0000-000000000001','pd000006-0000-0000-0000-000000000006',10, 99.95,0.05),
('so000001-0000-0000-0000-000000000001','pd000007-0000-0000-0000-000000000007', 5,169.95,0.05),
('so000002-0000-0000-0000-000000000002','pd000002-0000-0000-0000-000000000002', 3,169.95,0),
('so000002-0000-0000-0000-000000000002','pd000015-0000-0000-0000-000000000015', 5, 99.95,0),
('so000003-0000-0000-0000-000000000003','pd000005-0000-0000-0000-000000000005',30, 74.95,0.10),
('so000003-0000-0000-0000-000000000003','pd000006-0000-0000-0000-000000000006',20, 99.95,0.10),
('so000003-0000-0000-0000-000000000003','pd000023-0000-0000-0000-000000000023',30, 45.00,0.10);
...
VALUES
('rt000001-0000-0000-0000-000000000001','11111111-1111-1111-1111-111111111111',
 'Lima → Arequipa','Lima','Arequipa',16.0,1010.0,'Shalom'),
('rt000002-0000-0000-0000-000000000002','11111111-1111-1111-1111-111111111111',
 'Lima → Trujillo','Lima','Trujillo', 9.0, 558.0,'Olva Courier'),
('rt000003-0000-0000-0000-000000000003','11111111-1111-1111-1111-111111111111',
 'Lima → Cusco','Lima','Cusco',    24.0,1105.0,'DHL Express'),
('rt000004-0000-0000-0000-000000000004','11111111-1111-1111-1111-111111111111',
 'Arequipa → Moquegua','Arequipa','Moquegua', 3.5, 225.0,'Shalom'),
('rt000005-0000-0000-0000-000000000005','11111111-1111-1111-1111-111111111111',
...
VALUES
('11111111-1111-1111-1111-111111111111',
 'so000001-0000-0000-0000-000000000001','wh000001-0000-0000-0000-000000000001','rt000001-0000-0000-0000-000000000001',
 CURRENT_DATE-2, CURRENT_DATE+1,'en_transito','Shalom','SHL-2025-NK001'),
('11111111-1111-1111-1111-111111111111',
 'so000002-0000-0000-0000-000000000002','wh000002-0000-0000-0000-000000000002','rt000004-0000-0000-0000-000000000004',
 CURRENT_DATE,   CURRENT_DATE+1,'preparacion','Shalom','SHL-2025-NK002'),
('11111111-1111-1111-1111-111111111111',
 'so000003-0000-0000-0000-000000000003','wh000001-0000-0000-0000-000000000001','rt000002-0000-0000-0000-000000000002',
...
('11111111-1111-1111-1111-111111111111','33333333-3333-3333-3333-333333333333',
 'TRASLADO_APROBADO','transfer_orders','tr000001-0000-0000-0000-000000000001',
...
('11111111-1111-1111-1111-111111111111','22222222-2222-2222-2222-222222222222',
 'ORDEN_COMPRA_GENERADA','purchase_orders','po000002-0000-0000-0000-000000000002',
