...
('d0000003-0000-0000-0000-000000000003',1,
...
('d0000004-0000-0000-0000-000000000004',3,
...
('d0000005-0000-0000-0000-000000000005',3,
...
('d0000006-0000-0000-0000-000000000006',3,
...
('d0000007-0000-0000-0000-000000000007',4,
...
('d0000008-0000-0000-0000-000000000008',4,
...
('d0000009-0000-0000-0000-000000000009',4,
...
('d0000010-0000-0000-0000-000000000010',4,
...
('d0000011-0000-0000-0000-000000000011',5,
...
('d0000012-0000-0000-0000-000000000012',5,
...
('d0000013-0000-0000-0000-000000000013',5,
...
('d0000014-0000-0000-0000-000000000014',5,
...
('d0000015-0000-0000-0000-000000000015',3,
...
('d0000016-0000-0000-0000-000000000016',3,
...
('d0000017-0000-0000-0000-000000000017',6,
...
('d0000018-0000-0000-0000-000000000018',7,
...
('d0000019-0000-0000-0000-000000000019',7,
...
('d0000020-0000-0000-0000-000000000020',8,
...
('d0000001-0000-0000-0000-000000000001','c0000001-0000-0000-0000-000000000001',  6,25,300,'A-01'),  -- CRÍTICO
('d0000002-0000-0000-0000-000000000002','c0000001-0000-0000-0000-000000000001', 48,20,250,'A-02'),
('d0000003-0000-0000-0000-000000000003','c0000001-0000-0000-0000-000000000001', 32,15,200,'A-03'),
('d0000004-0000-0000-0000-000000000004','c0000001-0000-0000-0000-000000000001',125,30,400,'B-01'),
('d0000005-0000-0000-0000-000000000005','c0000001-0000-0000-0000-000000000001',  9,20,300,'B-02'),  -- CRÍTICO
('d0000006-0000-0000-0000-000000000006','c0000001-0000-0000-0000-000000000001', 60,15,200,'B-03'),
('d0000008-0000-0000-0000-000000000008','c0000001-0000-0000-0000-000000000001',  4,20,250,'C-01'),  -- CRÍTICO
('d0000011-0000-0000-0000-000000000011','c0000001-0000-0000-0000-000000000001', 28,15,200,'C-02'),
('d0000013-0000-0000-0000-000000000013','c0000001-0000-0000-0000-000000000001',  8,15,200,'C-03'),  -- CRÍTICO
('d0000020-0000-0000-0000-000000000020','c0000001-0000-0000-0000-000000000001',180,40,600,'D-01'),
-- Hub Lima Norte (swh00002)
('d0000004-0000-0000-0000-000000000004','c0000002-0000-0000-0000-000000000002', 80,20,250,'A-01'),
('d0000007-0000-0000-0000-000000000007','c0000002-0000-0000-0000-000000000002', 45,15,200,'A-02'),
('d0000015-0000-0000-0000-000000000015','c0000002-0000-0000-0000-000000000002', 40,15,200,'A-03'),
('d0000016-0000-0000-0000-000000000016','c0000002-0000-0000-0000-000000000002', 35,15,200,'B-01'),
('d0000017-0000-0000-0000-000000000017','c0000002-0000-0000-0000-000000000002', 55,10,150,'B-02'),
-- Arequipa (swh00003)
('d0000001-0000-0000-0000-000000000001','c0000003-0000-0000-0000-000000000003',160,25,300,'A-01'),
('d0000003-0000-0000-0000-000000000003','c0000003-0000-0000-0000-000000000003', 40,15,200,'A-02'),
('d0000005-0000-0000-0000-000000000005','c0000003-0000-0000-0000-000000000003', 95,20,300,'A-03'),
('d0000008-0000-0000-0000-000000000008','c0000003-0000-0000-0000-000000000003', 70,20,250,'B-01'),
('d0000018-0000-0000-0000-000000000018','c0000003-0000-0000-0000-000000000003', 20,10,100,'B-02'),
-- Cusco (swh00004)
('d0000004-0000-0000-0000-000000000004','c0000004-0000-0000-0000-000000000004', 55,15,150,'A-01'),
('d0000006-0000-0000-0000-000000000006','c0000004-0000-0000-0000-000000000004', 30,10,100,'A-02'),
('d0000012-0000-0000-0000-000000000012','c0000004-0000-0000-0000-000000000004', 22,10,100,'A-03'),
('d0000019-0000-0000-0000-000000000019','c0000004-0000-0000-0000-000000000004', 15,10,100,'B-01'),
-- Trujillo (swh00005)
('d0000004-0000-0000-0000-000000000004','c0000005-0000-0000-0000-000000000005', 70,20,200,'A-01'),
('d0000005-0000-0000-0000-000000000005','c0000005-0000-0000-0000-000000000005', 45,15,150,'A-02'),
('d0000011-0000-0000-0000-000000000011','c0000005-0000-0000-0000-000000000005', 33,10,120,'A-03'),
('d0000013-0000-0000-0000-000000000013','c0000005-0000-0000-0000-000000000005', 40,10,120,'B-01'),
('d0000020-0000-0000-0000-000000000020','c0000005-0000-0000-0000-000000000005',110,30,400,'B-02');
...
VALUES
('d0000001-0000-0000-0000-000000000001','c0000001-0000-0000-0000-000000000001','salida',   42,'SO-2025-001','Pedido Sport Center Lima','Carlos Meza',     NOW()-INTERVAL '5 days'),
('d0000004-0000-0000-0000-000000000004','c0000001-0000-0000-0000-000000000001','entrada', 200,'OC-2025-001','Recepción proveedor Nike Global Supply','Carlos Meza',NOW()-INTERVAL '10 days'),
('d0000005-0000-0000-0000-000000000005','c0000001-0000-0000-0000-000000000001','salida',   30,'SO-2025-002','Distribución Sport Zone Miraflores','Ana Torres',   NOW()-INTERVAL '3 days'),
('d0000008-0000-0000-0000-000000000008','c0000001-0000-0000-0000-000000000001','salida',   25,'SO-2025-003','Evento Nike Run Lima 2025','Ana Torres',          NOW()-INTERVAL '7 days'),
('d0000001-0000-0000-0000-000000000001','c0000003-0000-0000-0000-000000000003','entrada', 200,'OC-2025-002','Reabastecimiento Q3 2025','Pedro Salas',          NOW()-INTERVAL '20 days'),
('d0000020-0000-0000-0000-000000000020','c0000001-0000-0000-0000-000000000001','ajuste',  -10,'AJ-2025-001','Diferencia inventario físico vs sistema','Jorge Ramos',NOW()-INTERVAL '2 days'),
('d0000003-0000-0000-0000-000000000003','c0000003-0000-0000-0000-000000000003','salida',   15,'SO-2025-004','Pedido Mega Deportes Arequipa','Carlos Salas',    NOW()-INTERVAL '4 days'),
('d0000006-0000-0000-0000-000000000006','c0000004-0000-0000-0000-000000000004','entrada',  50,'OC-2025-003','Reposición almacén Cusco','María Quispe',         NOW()-INTERVAL '15 days'),
('d0000004-0000-0000-0000-000000000004','c0000005-0000-0000-0000-000000000005','entrada', 100,'OC-2025-004','Abastecimiento hub Trujillo','Luis Vargas',         NOW()-INTERVAL '25 days'),
('d0000011-0000-0000-0000-000000000011','c0000005-0000-0000-0000-000000000005','salida',   20,'SO-2025-005','Pedido Deportes La Libertad Trujillo','Luis Vargas',NOW()-INTERVAL '6 days'),
('d0000005-0000-0000-0000-000000000005','c0000002-0000-0000-0000-000000000002','transferencia',30,'TR-2025-001','Transferencia desde Lima Norte a Lima Centro','Jorge Ramos',NOW()-INTERVAL '1 day'),
('d0000018-0000-0000-0000-000000000018','c0000003-0000-0000-0000-000000000003','entrada',  30,'OC-2025-005','Reposición Tiempo Legend Arequipa','Carlos Salas', NOW()-INTERVAL '8 days');
...
('str00001-0000-0000-0000-000000000001',
 ...
 'c0000003-0000-0000-0000-000000000003','c0000001-0000-0000-0000-000000000001',
...
('a0000001-0000-0000-0000-000000000001','e0000001-0000-0000-0000-000000000001',
 ...
 'c0000001-0000-0000-0000-000000000001','Importación Q2 2025 — Air Force 1 y Air Max'),
('a0000002-0000-0000-0000-000000000002',
 'e0000002-0000-0000-0000-000000000002',
 'OC-2025-002',CURRENT_DATE-45,CURRENT_DATE-10,NULL,'shipped',124800.00,
 'c0000003-0000-0000-0000-000000000003','Lote VaporMax y Air Max 270 React — temporada invierno'),
('a0000003-0000-0000-0000-000000000003',
 'e0000003-0000-0000-0000-000000000003',
 'OC-2025-003',CURRENT_DATE-20,CURRENT_DATE+10,NULL,'confirmed',65400.00,
 'c0000001-0000-0000-0000-000000000001','Metcon 7 y SuperRep Go — línea Training'),
('a0000004-0000-0000-0000-000000000004',
 'e0000004-0000-0000-0000-000000000004',
 'OC-2025-004',CURRENT_DATE-5, CURRENT_DATE+5, NULL,'pending',  8950.00,
 'c0000001-0000-0000-0000-000000000001','Reposición urgente stock crítico Lima Centro'),
('a0000005-0000-0000-0000-000000000005',
 'e0000004-0000-0000-0000-000000000004',
 'OC-2025-005',CURRENT_DATE-2, CURRENT_DATE+8, NULL,'pending',  5600.00,
 'c0000003-0000-0000-0000-000000000003','Ropa Dri-FIT para reposición Arequipa'),
('a0000006-0000-0000-0000-000000000006',
 'e0000001-0000-0000-0000-000000000001',
 'OC-2025-006',CURRENT_DATE-60,CURRENT_DATE-25,CURRENT_DATE-22,'received',211500.00,
 'c0000002-0000-0000-0000-000000000002','Lote gigante Q1 2025 — Lifestyle completo'),
('a0000007-0000-0000-0000-000000000007',
 'e0000005-0000-0000-0000-000000000005',
 'OC-2025-007',CURRENT_DATE-3, CURRENT_DATE+7, NULL,'pending',  3200.00,
 'c0000005-0000-0000-0000-000000000005','Reposición Trujillo — Running y Training'),
('a0000008-0000-0000-0000-000000000008',
 'e0000002-0000-0000-0000-000000000002',
 'OC-2025-008',CURRENT_DATE-15,CURRENT_DATE+30,NULL,'confirmed',78200.00,
 'c0000003-0000-0000-0000-000000000003','Importación Fútbol — Tiempo Legend y Mercurial Q3');

INSERT INTO purchase_order_items (purchase_order_id, product_id, quantity_ordered, quantity_received, unit_cost) VALUES
('a0000001-0000-0000-0000-000000000001','d0000004-0000-0000-0000-000000000004',500,500,42.00),
('a0000001-0000-0000-0000-000000000001','d0000005-0000-0000-0000-000000000005',300,300,58.00),
('a0000002-0000-0000-0000-000000000002','d0000002-0000-0000-0000-000000000002',400,  0,100.00),
('a0000002-0000-0000-0000-000000000002','d0000003-0000-0000-0000-000000000003',350,  0, 90.00),
('a0000003-0000-0000-0000-000000000003','d0000014-0000-0000-0000-000000000014',300,  0, 75.00),
('a0000003-0000-0000-0000-000000000003','d0000013-0000-0000-0000-000000000013',450,  0, 45.00),
('a0000004-0000-0000-0000-000000000004','d0000001-0000-0000-0000-000000000001', 60,  0, 95.00),
('a0000004-0000-0000-0000-000000000004','d0000008-0000-0000-0000-000000000008', 50,  0, 58.00),
('a0000008-0000-0000-0000-000000000008','d0000018-0000-0000-0000-000000000018',200,  0,135.00),
('a0000008-0000-0000-0000-000000000008','d0000019-0000-0000-0000-000000000019',150,  0,155.00);
...
('sso00001-0000-0000-0000-000000000001','d0000004-0000-0000-0000-000000000004',50, 74.95,0.05),
('sso00001-0000-0000-0000-000000000001','d0000005-0000-0000-0000-000000000005',30, 99.95,0.05),
('sso00002-0000-0000-0000-000000000002','d0000018-0000-0000-0000-000000000018',10,229.90,0),
('sso00002-0000-0000-0000-000000000002','d0000019-0000-0000-0000-000000000019', 5,259.90,0),
('sso00003-0000-0000-0000-000000000003','d0000004-0000-0000-0000-000000000004',100,74.95,0.12),
('sso00003-0000-0000-0000-000000000003','d0000005-0000-0000-0000-000000000005', 80,99.95,0.12),
('sso00003-0000-0000-0000-000000000003','d0000006-0000-0000-0000-000000000006', 50,169.95,0.12),
('sso00004-0000-0000-0000-000000000004','d0000011-0000-0000-0000-000000000011',15, 99.95,0),
('sso00004-0000-0000-0000-000000000004','d0000013-0000-0000-0000-000000000013',20, 79.95,0),
('sso00005-0000-0000-0000-000000000005','d0000006-0000-0000-0000-000000000006',10,169.95,0.05),
('sso00005-0000-0000-0000-000000000005','d0000017-0000-0000-0000-000000000017',15, 89.95,0.05);
...
VALUES
('sso00001-0000-0000-0000-000000000001','c0000001-0000-0000-0000-000000000001','srt00001-0000-0000-0000-000000000001',
 'SHIP-2025-001',CURRENT_DATE-3,CURRENT_DATE+1,'en_transito','Shalom','SHL-2025-NK101',125.5,NULL),
('sso00002-0000-0000-0000-000000000002','c0000003-0000-0000-0000-000000000003','srt00004-0000-0000-0000-000000000004',
 'SHIP-2025-002',CURRENT_DATE,  CURRENT_DATE+1,'preparacion','Shalom','SHL-2025-NK102', 62.0,NULL),
('sso00003-0000-0000-0000-000000000003','c0000001-0000-0000-0000-000000000001','srt00002-0000-0000-0000-000000000002',
...
('sso00004-0000-0000-0000-000000000004','c0000002-0000-0000-0000-000000000002','srt00002-0000-0000-0000-000000000002',
 'SHIP-2025-004',CURRENT_DATE+1,CURRENT_DATE+3,'preparacion','Olva Courier','OLV-2025-NK102', 55.0,NULL),
('sso00005-0000-0000-0000-000000000005','c0000003-0000-0000-0000-000000000003','srt00005-0000-0000-0000-000000000005',
